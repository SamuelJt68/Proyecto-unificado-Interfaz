...
public class VistaNuevaReserva extends JPanel implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (command.equals("Disponibilidad")) {
            ...
            int iCli = interfaz.getComparador().compararCliente(interfaz.getEmpresa().getUsuarioActual().getUsuario());
            interfaz.getEmpresa().getClientes().get(iCli).crearReserva(new Date(2023, 1, 22, 6, 0), new Date(2023, 2, 22, 6, 0), 100, interfaz.getEmpresa().getCategorias().get(interfaz.getComparador().compararCategoria(categoria)), interfaz.getEmpresa().getSedes().get(interfaz.getComparador().compararSede(sedeRecogida)), interfaz.getEmpresa().getSedes().get(interfaz.getComparador().compararSede(sedeEntrega)));
        	interfaz.vistaPago();
        }
    }
}
